...
type Config struct {
	HTTPPort int `envconfig:"PAYMENT_HTTP_PORT" default:"8082"`
	...
	// Mock gateway tuning. 0.85 = 85% of charges succeed, 15% are declined.
	GatewaySuccessRate float64 `envconfig:"PAYMENT_GATEWAY_SUCCESS_RATE" default:"0.85"`
}
